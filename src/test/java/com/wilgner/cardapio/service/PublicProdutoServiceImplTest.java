...
class PublicProdutoServiceImplTest {
    ...
    void listarProdutoDinamico_ThrowsException_WhenEstabelecimentoNotFound() {
        when(estabelecimentoRepository.findBySlug("nao-existe"))
                .thenReturn(Optional.empty());

        ResourceNotFoundException exception = assertThrows(
                ResourceNotFoundException.class,
                () -> publicProdutoService.listarProdutoDinamico(
                        "nao-existe",
                        null
                )
        );
        ...
        verify(
                produtoRepository,
                never()
        ).findByEstabelecimentoCategoriaAtivoOrderByOrdem(
                any(),
                any()
        );
        ...
        verify(
                produtoRepository,
                never()
        ).findByEstabelecimentoAtivoOrderByCategoriaAndOrdem(
                any()
        );
    }
    ...
    void listarProdutoDinamico_ThrowsException_WhenEstabelecimentoInactive() {
        when(estabelecimentoRepository.findBySlug("loja-inativa"))
                .thenReturn(Optional.of(estabelecimentoInativo));
    ...
    void listarProdutoDinamico_ReturnsProductsFilteredByCategory_WhenCategoriaIsProvided() {
        ...
        List<ProdutoResponseDTO> responseDTOs =
                List.of(produtoResponseDTO1);

        when(estabelecimentoRepository.findBySlug(slug))
                .thenReturn(Optional.of(estabelecimentoAtivo));
        ...
        when(produtoMapper.toDTOList(produtos))
    ...
    void obterInfoEstabelecimento_ThrowsException_WhenEstabelecimentoNotFound() {
        ...
        ResourceNotFoundException exception = assertThrows(
                ResourceNotFoundException.class,
                () -> publicProdutoService
                        .obterInfoEstabelecimento("nao-existe")
        );
    ...
    void obterInfoEstabelecimento_ThrowsException_WhenEstabelecimentoInactive() {
        ...
        ResourceNotFoundException exception = assertThrows(
                ResourceNotFoundException.class,
                () -> publicProdutoService
                        .obterInfoEstabelecimento("loja-inativa")
        );
    ...
    void obterInfoEstabelecimento_ReturnsEstabelecimentoInfoDTO_WhenFoundAndActive() {
        ...
        PublicProdutoServiceImpl.EstabelecimentoInfoDTO result =
                publicProdutoService.obterInfoEstabelecimento(slug);
